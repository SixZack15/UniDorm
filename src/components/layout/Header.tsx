        ...
        <header className="bg-primary text-white shadow-md fixed top-0 left-0 right-0 z-50 h-16 flex items-center px-4 justify-between">
            ...
            <div className="flex items-center gap-4">
                ...
                <nav className="hidden lg:flex items-center gap-6 ml-8 text-sm font-medium">
                    ...
                    <Link href="/rooms" className="hover:text-white/80 transition-colors">Rooms</Link>
                    <Link href="/finance" className="hover:text-white/80 transition-colors">Finance</Link>
                    <Link href="/requests" className="hover:text-white/80 transition-colors">Requests</Link>
                </nav>
            </div>
