        ...
        <div className="space-y-6">
            ...
            <div className="bg-blue-50 border-l-4 border-blue-500 p-4 flex justify-between items-center">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <p className="font-bold text-blue-900">Cần xếp phòng</p>
                        <p className="text-sm text-blue-700">Có <span className="font-bold">15 Sinh viên</span> đã duyệt hồ sơ đang chờ xếp phòng.</p>
                    </div>
                </div>
                <Link href="#" className="text-sm font-bold text-blue-700 hover:text-blue-900 flex items-center gap-1">
                    ĐẾN TRANG XẾP PHÒNG
