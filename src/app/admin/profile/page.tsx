...
export default function AdminProfilePage() {
    ...
    // Mock Data - Reusing student profile structure but with admin-specific info
    const [user, setUser] = useState({
        fullName: 'Nguyễn Văn Admin',
        employeeId: 'ADM001',
        vluEmail: 'admin@vanlanguni.vn',
    ...
    return (
        <div className="space-y-6">
            ...
            <nav className="flex text-sm text-gray-500">
                <a href="/admin/dashboard" className="hover:text-primary">Trang chủ</a>
                <span className="mx-2">/</span>
                <span className="text-gray-900 font-medium">Hồ sơ quản trị viên</span>
            </nav>
                ...
                <div className="lg:col-span-4 xl:col-span-3">
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex flex-col items-center text-center sticky top-24">
                        <div className="relative mb-4">
                            <div className="w-32 h-32 rounded-full bg-red-100 flex items-center justify-center text-4xl font-bold text-primary border-4 border-white shadow-lg">
                ...
                <div className="lg:col-span-8 xl:col-span-9">
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                        <div className="px-6 py-4 border-b border-gray-100 bg-gray-50 flex justify-between items-center">
                            <h3 className="font-bold text-gray-900 text-lg">THÔNG TIN TÀI KHOẢN QUẢN TRỊ</h3>
                        </div>
