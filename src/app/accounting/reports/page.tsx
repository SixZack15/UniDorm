...
export default function AccountingReportsPage() {
    ...
    // Mock Data for Table - Detailed Financial Breakdown
    const reportData = [
        { item: 'Phí phòng - Block A', code: '5111', plan: '800.000.000đ', actual: '750.000.000đ' },
        { item: 'Phí phòng - Block B', code: '5111', plan: '1.000.000.000đ', actual: '870.000.000đ' },
        { item: 'Tiền điện - Block A', code: '5112', plan: '45.000.000đ', actual: '42.000.000đ' },
        { item: 'Tiền điện - Block B', code: '5112', plan: '55.000.000đ', actual: '48.000.000đ' },
        { item: 'Tiền nước - Block A', code: '5113', plan: '40.000.000đ', actual: '38.000.000đ' },
        { item: 'Tiền nước - Block B', code: '5113', plan: '60.000.000đ', actual: '52.000.000đ' },
        { item: 'Phí dịch vụ khác', code: '5118', plan: '50.000.000đ', actual: '45.000.000đ' },
        { item: 'TỔNG CỘNG', code: '', plan: '2.050.000.000đ', actual: '1.845.000.000đ', isTotal: true },
    ];

    // Mock Data for Recent Transactions
    const recentTransactions = [
        { id: 'TRX-001', date: '25/11/2025', desc: 'Thu tiền phòng - Nguyễn Văn A', category: 'Thu tiền phòng', account: '111', amount: '+ 2.500.000đ', status: 'completed' },
        { id: 'TRX-002', date: '25/11/2025', desc: 'Thanh toán tiền điện - EVN', category: 'Chi phí điện', account: '331', amount: '- 15.000.000đ', status: 'pending' },
        { id: 'TRX-003', date: '24/11/2025', desc: 'Thu tiền nước - Trần Thị B', category: 'Thu tiền nước', account: '112', amount: '+ 150.000đ', status: 'completed' },
        { id: 'TRX-004', date: '24/11/2025', desc: 'Chi phí bảo trì thang máy', category: 'Chi phí bảo trì', account: '642', amount: '- 5.000.000đ', status: 'completed' },
    ];
    ...
    return (
        <div className="space-y-6">
            ...
            <nav className="flex text-sm text-gray-500">
                <Link href="/accounting/dashboard" className="hover:text-primary">Trang chính</Link>
                                ...
                                <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                                    <div>
                                        <p className="text-sm text-gray-700">
                                            Hiển thị <span className="font-medium">1</span> đến <span className="font-medium">8</span> trong số <span className="font-medium">8</span> kết quả
                                        </p>
                                    </div>
                                    <div>
