...
export default function AccountingProfilePage() {
    ...
    // Mock Data - Accounting profile
    const [user, setUser] = useState({
        fullName: 'Nguyễn Thị Tài Chính',
        employeeId: 'ACC001',
        vluEmail: 'accounting@vanlanguni.vn',
        department: 'Bộ phận Quản lý Tài chính',
        position: 'Kế toán trưởng',
        status: 'Đang hoạt động',
        phone: '0901234567',
        personalEmail: 'accounting@gmail.com',
    ...
    return (
        <div className="space-y-6">
            ...
            <nav className="flex text-sm text-gray-500">
                <Link href="/accounting/dashboard" className="hover:text-emerald-600">Trang chủ</Link>
                <span className="mx-2">/</span>
                <span className="text-gray-900 font-medium">Hồ sơ tài chính</span>
            </nav>
                ...
                <div className="lg:col-span-4 xl:col-span-3">
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex flex-col items-center text-center sticky top-24">
                        <div className="relative mb-4">
                            ...
                            <button className="absolute bottom-0 right-0 bg-emerald-600 text-white p-2 rounded-full hover:bg-emerald-700 transition-colors shadow-md" title="Tải ảnh đại diện">
                ...
                <div className="lg:col-span-8 xl:col-span-9">
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                        <div className="px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-emerald-50 to-teal-50 flex justify-between items-center">
                            <h3 className="font-bold text-gray-900 text-lg">THÔNG TIN TÀI KHOẢN TÀI CHÍNH</h3>
                        </div>

                        <div className="p-6 space-y-8">
                            {/* Section 1: Employee Info */}
                            <section>
                                <h4 className="text-sm font-bold text-emerald-700 uppercase tracking-wider mb-4 border-b border-gray-100 pb-2">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            disabled
                                            className="block w-full rounded-md border-gray-300 bg-gray-100 text-gray-500 shadow-sm focus:border-emerald-600 focus:ring-emerald-600 sm:text-sm cursor-not-allowed"
                                        />
                                    </div>
                                    <div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="block w-full rounded-md border-gray-300 shadow-sm focus:border-emerald-600 focus:ring-emerald-600 sm:text-sm"
                                        />
                                    </div>
                                    <div>
                            ...
                            <div className="flex items-center justify-between gap-4 pt-6 border-t border-gray-100">
                                ...
                                <div className="flex gap-4">
                                    <button className="px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-600">
                                        Đổi mật khẩu
                                    </button>
                                    <button onClick={handleSaveChanges} className="px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-emerald-600 hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-600">
                                        Lưu thay đổi
                                    </button>
                                </div>
                            </div>
