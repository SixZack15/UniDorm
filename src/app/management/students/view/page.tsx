                ...
                <div className="bg-gradient-to-r from-primary to-primary-dark p-6 text-white">
                    <div className="flex items-center gap-6">
                        ...
                        <div>
                            ...
                            <p className="text-primary-light mt-1">Mã sinh viên: {student.id}</p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div>
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="flex items-start">
                                    <span className="text-sm font-medium text-gray-500 w-32">Số điện thoại:</span>
                                    <span className="text-sm text-gray-900">{student.phone}</span>
                                </div>
                                <div className="flex items-start">
                                    <span className="text-sm font-medium text-gray-500 w-32">Khoa:</span>
                                    <span className="text-sm text-gray-900">{student.faculty}</span>
                                </div>
                                <div className="flex items-start">
                                    <span className="text-sm font-medium text-gray-500 w-32">Phòng hiện tại:</span>
                        ...
                        <div>
                            ...
                            <div className="space-y-3">
                                <div className="flex items-start">
                                    <span className="text-sm font-medium text-gray-500 w-32">Tên phụ huynh:</span>
                                    <span className="text-sm text-gray-900">{student.parentName}</span>
                                </div>
                                <div className="flex items-start">
                                    <span className="text-sm font-medium text-gray-500 w-32">Số điện thoại phụ huynh:</span>
                                    <span className="text-sm text-gray-900">{student.parentPhone}</span>
                                </div>
                                <div className="flex items-start">
                                    <span className="text-sm font-medium text-gray-500 w-32">Email phụ huynh:</span>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                <div className="bg-gray-50 px-6 py-4 border-b border-gray-200">
                    <h3 className="text-lg font-bold text-gray-900 flex items-center">
                        ...
                        Lịch sử Check-in & Checkout
                    </h3>
                    <p className="text-sm text-gray-600 mt-1">Xem tất cả lịch sử checkin và checkout của sinh viên</p>
                </div>
                                            ...
                                            <div className="flex items-center gap-2">
                                                {record.checkOutDate ? (
                                                    ...
                                                    <>
                                                        ...
                                                        <div>
                                                            <span className="text-gray-500 font-medium">Checkout:</span>
                                                            <span className="ml-2 text-emerald-600 font-semibold">Hoạt động</span>
                                                        </div>
                                                    </>
                                                )}
                                            </div>
